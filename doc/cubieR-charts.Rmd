...
```{r princeton_original, fig.cap = "Original visualisation", fig.height = 2}
#| warnings: false  
#| echo: false  
princeton_aid.tbl = 
  read_csv(
...
```{r princeton_decomposed, fig.cap = "Decomposed visualisation", fig.height = 2}
#| warnings: false   
#| echo: false  
...
```{r princeton_line,  fig.cap = "Simplified visualisation", fig.height = 2} 
#| warnings: false   
#| echo: false    
